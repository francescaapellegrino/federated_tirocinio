...
# Generata automaticamente il 2025-08-20 15:44:01
# Utente: francescaapellegrino
# Timestamp: 20250820_154401
# ============================================================================
...
class OptimizedConfig:
    ...
    LEARNING_RATE = 0.0013892209
    L2_REG = 0.0027756292
    
    # ARCHITETTURA OTTIMIZZATA (4-layer)
    HIDDEN_LAYERS = [144, 120, 16, 12]
    DROPOUT_RATES = [0.100, 0.300, 0.400, 0.300]
    ...
    OPTIMIZATION_TIMESTAMP = "20250820_154401"
    OPTIMIZATION_SCORE = 0.654129
    ...
    ARCHITECTURE_SUMMARY = "144→120→16→12→1"
